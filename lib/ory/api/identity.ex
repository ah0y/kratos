defmodule Ory.Api.Identity do
  @moduledoc """
  Behaviour for `Identity`.
  """

  @callback batch_patch_identities(Tesla.Env.client(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.BatchPatchIdentitiesResponse.t()}
              | {:error, Tesla.Env.t()}

  def batch_patch_identities(connection, opts),
    do: impl().batch_patch_identities(connection, opts)

  @callback create_identity(Tesla.Env.client(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Identity.t()}
              | {:error, Tesla.Env.t()}

  def create_identity(connection, opts), do: impl().create_identity(connection, opts)

  @callback create_recovery_code_for_identity(Tesla.Env.client(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.RecoveryCodeForIdentity.t()}
              | {:error, Tesla.Env.t()}

  def create_recovery_code_for_identity(connection, opts),
    do: impl().create_recovery_code_for_identity(connection, opts)

  @callback create_recovery_link_for_identity(Tesla.Env.client(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.RecoveryLinkForIdentity.t()}
              | {:error, Tesla.Env.t()}

  def create_recovery_link_for_identity(connection, opts),
    do: impl().create_recovery_link_for_identity(connection, opts)

  @callback delete_identity(Tesla.Env.client(), String.t()) ::
              {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}

  def delete_identity(connection, id),
    do: impl().delete_identity(connection, id)

  @callback delete_identity_credentials(Tesla.Env.client(), String.t(), String.t()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Identity.t()}
              | {:error, Tesla.Env.t()}

  def delete_identity_credentials(connection, id, type),
    do: impl().delete_identity_credentials(connection, id, type)

  @callback delete_identity_sessions(Tesla.Env.client(), String.t()) ::
              {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}

  def delete_identity_sessions(connection, id),
    do: impl().delete_identity_sessions(connection, id)

  @callback disable_session(Tesla.Env.client(), String.t()) ::
              {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}

  def disable_session(connection, id),
    do: impl().disable_session(connection, id)

  @callback extend_session(Tesla.Env.client(), String.t()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Session.t()}
              | {:error, Tesla.Env.t()}

  def extend_session(connection, id), do: impl().extend_session(connection, id)

  @callback get_identity(Tesla.Env.client(), String.t(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Identity.t()}
              | {:error, Tesla.Env.t()}

  def get_identity(connection, id, opts), do: impl().get_identity(connection, id, opts)

  @callback get_identity_schema(Tesla.Env.client(), String.t()) ::
              {:ok, Ory.Model.ErrorGeneric.t()} | {:ok, map()} | {:error, Tesla.Env.t()}

  def get_identity_schema(connection, id),
    do: impl().get_identity_schema(connection, id)

  @callback get_session(Tesla.Env.client(), String.t(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Session.t()}
              | {:error, Tesla.Env.t()}

  def get_session(connection, id, opts), do: impl().get_session(connection, id, opts)

  @callback list_identities(Tesla.Env.client(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, list(Ory.Model.Identity.t())}
              | {:error, Tesla.Env.t()}

  def list_identities(connection, opts), do: impl().list_identities(connection, opts)

  @callback list_identity_schemas(Tesla.Env.client(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, list(Ory.Model.IdentitySchemaContainer.t())}
              | {:error, Tesla.Env.t()}

  def list_identity_schemas(connection, opts),
    do: impl().list_identity_schemas(connection, opts)

  @callback list_identity_sessions(Tesla.Env.client(), String.t(), keyword()) ::
              {:ok, list(Ory.Model.Session.t())}
              | {:ok, Ory.Model.ErrorGeneric.t()}
              | {:error, Tesla.Env.t()}

  def list_identity_sessions(connection, id, opts),
    do: impl().list_identity_sessions(connection, id, opts)

  @callback list_sessions(Tesla.Env.client(), keyword()) ::
              {:ok, list(Ory.Model.Session.t())}
              | {:ok, Ory.Model.ErrorGeneric.t()}
              | {:error, Tesla.Env.t()}

  def list_sessions(connection, opts), do: impl().list_sessions(connection, opts)

  @callback patch_identity(Tesla.Env.client(), String.t(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Identity.t()}
              | {:error, Tesla.Env.t()}

  def patch_identity(connection, id, opts), do: impl().patch_identity(connection, id, opts)

  @callback update_identity(Tesla.Env.client(), String.t(), keyword()) ::
              {:ok, Ory.Model.ErrorGeneric.t()}
              | {:ok, Ory.Model.Identity.t()}
              | {:error, Tesla.Env.t()}

  def update_identity(connection, id, opts),
    do: impl().update_identity(connection, id, opts)

  defp impl do
    Application.get_env(:ory_kratos, :identity_client, Ory.Api.Identity.Client)
  end
end

defmodule Ory.Api.Identity.Client do
  @moduledoc """
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_identity(Tesla.Env.client(), String.t()) ::
          {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}
  def delete_identity(connection, id) do
    request =
      %{}
      |> method(:delete)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_identity_credentials(Tesla.Env.client(), String.t(), String.t()) ::
          {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}
  def delete_identity_credentials(connection, id, type) do
    request =
      %{}
      |> method(:delete)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_identity_sessions(Tesla.Env.client(), String.t()) ::
          {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}
  def delete_identity_sessions(connection, id) do
    request =
      %{}
      |> method(:delete)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec disable_session(Tesla.Env.client(), String.t()) ::
          {:ok, nil} | {:ok, Ory.Model.ErrorGeneric.t()} | {:error, Tesla.Env.t()}
  def disable_session(connection, id) do
    request =
      %{}
      |> method(:delete)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec extend_session(Tesla.Env.client(), String.t()) ::
          {:ok, Ory.Model.ErrorGeneric.t()}
          | {:ok, Ory.Model.Session.t()}
          | {:error, Tesla.Env.t()}
  def extend_session(connection, id) do
    request =
      %{}
      |> method(:patch)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_identity_schema(Tesla.Env.client(), String.t()) ::
          {:ok, Ory.Model.ErrorGeneric.t()} | {:ok, Map.t()} | {:error, Tesla.Env.t()}
  def get_identity_schema(connection, id) do
    request =
      %{}
      |> method(:get)
      |> url("/schemas/#{id}")
